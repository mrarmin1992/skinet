...
namespace API.Controllers  // prikazuje gdje se nalaze klase 
{
                                                     ...
                                                     // ControllBase predstavlja bazu poznatih controllera-a, koja se ukljucuje koristenjem Microsoft.AspNetCore.Mvc
    {
        ...
        [HttpGet]
        public async Task<ActionResult<Pagination<ProductToReturnDto>>> GetProducts([FromQuery]ProductSpecParams productParams)  // ( async ) Asinkroni pozivi ne blokiraju (niti čekaju) da se API poziv vrati s poslužitelja. Izvršenje se nastavlja u vašem programu, a kad se poziv vrati s poslužitelja, izvršava se funkcija "povratnog poziva".
        {
